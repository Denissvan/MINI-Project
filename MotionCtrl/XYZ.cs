...
namespace MotionCtrl
{
    public partial class XYZ : UserControl
    {
        ...
        {
            get { return string.Format("{0},{1},{2}", nud_x.DecimalPlaces, nud_y.DecimalPlaces, nud_z.DecimalPlaces/*, nud_u.DecimalPlaces*/); }
            set
            {
        ...
        //[Browsable(true)]
        //[Description("XYZVisible")]
        //public String XYZVisible
        //{
        //    get { return string.Format("{0},{1},{2}", nud_x.Visible, nud_y.Visible, nud_z.Visible/* nud_u.Visible*/); }
        //    set
        //    {
        //        string[] str = value.Split(',');
        ...
        public ST_XYZ Value
        {
            get
            {
                return new ST_XYZ((double)nud_x.Value, (double)nud_y.Value, (double)nud_z.Value/*, (double)nud_u.Value*/) ;
            }
            set
            {
                try
                ...
                {
                    MessageBox.Show(VAR.IsChinese?string.Format("{0}赋值异常,{1}", this.Name, ex.Message): string.Format("{0} Assignment exception,{1}           ({0}赋值异常,{1})", this.Name, ex.Message)); 
                }
            }
        }
